...
import { ArrowLeft, Save, Upload, X, Plus, User, Briefcase, Target, Phone, MapPin } from 'lucide-react';
...
export const AddAgent: React.FC<AddAgentProps> = ({ onBack, onSave }) => {
  ...
  const steps = [
    ...
    { id: 3, name: 'Territory & Targets', icon: Target },
    { id: 4, name: 'Commission', icon: MapPin },
  ...
  const territories = [
    'Bangalore East Zone', 'Bangalore West Zone', 'Bangalore South Zone', 'Bangalore Central Zone',
    'Chennai Zone', 'Hyderabad Zone', 'Mumbai Zone'
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="agent@agents.ramnirmalchits.com"
                />
            ...
            {formData.monthlyTarget && formData.monthlyTarget > 0 && (
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                ...
                <div className="text-sm text-blue-800 space-y-1">
                  ...
                  <p>Quarterly Target: ₹{(formData.monthlyTarget * 3).toLocaleString('en-IN')}</p>
                  <p>Yearly Target: ₹{(formData.monthlyTarget * 12).toLocaleString('en-IN')}</p>
                </div>
              </div>
            )}
          </div>
