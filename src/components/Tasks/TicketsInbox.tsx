...
import { Plus, Search, Filter, Inbox, User, Clock, AlertTriangle, CheckCircle, MessageSquare, Phone, Mail, Calendar, Tag, Eye, CreditCard as Edit, Archive, Star, Flag, Users, Target, Award, TrendingUp, Zap, MoreVertical } from 'lucide-react' MoreVertical,
  ArrowLeft,
  Save,
  X,
  Trash2,
